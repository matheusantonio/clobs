<template>
  <header class="px-5 pt-4 bg-info text-white shadow">

      <div class="row">
        
        <div  class="col text-left">
          <div>
            <h1>Clojure Bookmark Service</h1>
          </div>
        </div>
        ...
        <div  class="col text-right">
          ...
          <div>
            <div v-if="this.$store.state.loged">
                <div class="align-middle">Welcome, {{username}}</div>
                  <div class="text-white mt-1" >
                      <button class="btn btn-outline-light btn-sm" @click="logout"> Logout
            ...
            <div v-else class="pr-2">
              ...
              <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-person-circle pr-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path d="M13.468 12.37C12.758 11.226 11.195 10 8 10s-4.757 1.225-5.468 2.37A6.987 6.987 0 0 0 8 15a6.987 6.987 0 0 0 5.468-2.63z"/>
                <path fill-rule="evenodd" d="M8 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                <path fill-rule="evenodd" d="M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1zM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8z"/>
              </svg>
              
              <router-link to="/login" type="button" class="text-white">
                    Login
              </router-link>

              or 

              <router-link to="/register" type="button" class="text-white">
                    Register
              </router-link>
      ...
      <div class="row justify-content-between">
          ...
          <div class="col-4 mt-3 mb-2">
            <form class="form-inline" @submit.prevent="search">
                    ...
                    <div type="submit" class="btn text-white">
